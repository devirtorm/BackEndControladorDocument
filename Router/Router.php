...
$router->get('/departamentoproceso/desactivados', 'Departamentos@obtenerDepartamentosDesactivados'); // Muestra los registros de las areas
$router->put('/departamentoproceso/:id/desactivar', 'Departamentos@desactivarDepartamento'); // Desactiva un departamento en especifico 
